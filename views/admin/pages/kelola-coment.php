...
require_once '../classes/post_coment.php';

$database = new Database;
$db = $database->getConnection();

$post = new Post_coment($db);
$stmt = $post->LiatComentAll();
$num = $stmt->rowCount();
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        if ($num > 0):
                                            ...
                                            <tr>
                                                ...
                                                foreach ($comments as $comment):
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="text-xs text-secondary mb-0 text-ellipsis">
                                                    ...
                                                    <?php
                                                        $encoded_id = base64_encode($comment['comment_id']);
                                                        ?>
                                                    <td class="align-middle">
                                                        <a href="../../../proses/proses-delete-comment.php?comment_id=<?php echo htmlspecialchars($encoded_id); ?> " class="text-secondary font-weight-bold text-xs"
                                                            data-toggle="tooltip" data-original-title="Edit user" onclick="confirm('yakin ingin menghapus comment');">
                                                            hapus 
                                                        </a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php else: ?>
                                            <?php echo "<tr><td colspan='6' class='text-center'>comments not found </td></tr>"; ?>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
                            </div>
