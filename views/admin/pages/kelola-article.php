...
require_once "../classes/posts_article.php";
...
$query = "SELECT user_id , username FROM users WHERE role = :role";
// Siapkan query
...
<body class="g-sidenav-show  bg-gray-100">
                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        INNER JOIN 
                                            article_categories ON articles.article_id = article_categories.article_id
                                        INNER JOIN 
                                            categories ON article_categories.category_id = categories.category_id
                                        GROUP BY 
                                            articles.article_id
                                    ";
                                        ...
                                        if ($num > 0) {
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <img src="../assets/img/team-2.jpg" class="avatar avatar-sm me-3 border-radius-lg" alt="user1">
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0 text-sm"><?php echo $author_name; ?></h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <p class="text-xs font-weight-bold mb-0"><?php echo $title; ?></p>
                                                    </td>
                                                    <style>
                                                        .text-ellipsis {
                                                            white-space: nowrap;
                                                            ...
                                                            /* Membatasi lebar elemen sesuai ukuran kontennya */
                                                        }
                                                    </style>
                                                    <td>
                                                        <p class="text-xs font-weight-bold mb-0 text-ellipsis"><?php echo $categories; ?></p>
                                                    </td>
                                                    <td class="align-middle text-center text-ellipsis">
                                                        <span
                                                            class="text-secondary text-xs font-weight-bold"><?php echo $content; ?></span>
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                        <?php

                                                        if ($status == 'draft') {
                                                            echo '<span class="badge badge-sm bg-gradient-secondary">Draft</span>';
                                                        } else if ($status == 'pending') {
                                                            echo '<span class="badge badge-sm bg-gradient-warning">Pending</span>';
                                                        } else {
                                                            echo '<span class="badge badge-sm bg-gradient-success">Published</span>';
                                                        }
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <?php if (!empty($updated_at)): ?>
                                                            <span class="text-secondary text-xs font-weight-bold">
                                                                Updated At: <?php echo htmlspecialchars($updated_at); ?>
                                                            </span>
                                                        <?php else: ?>
                                                            <span class="text-secondary text-xs font-weight-bold">
                                                                Created At: <?php echo htmlspecialchars($created_at); ?>
                                                            </span>
                                                        <?php endif; ?>
                                                    </td>

                                                    <td class="align-middle">
                                                        <a href="edit-article.php?id=<?php echo htmlspecialchars($article_id); ?>"
                                                            class="text-secondary font-weight-bold text-xs"
                                                            data-bs-toggle="tooltip" data-bs-title="Edit user">
                                                            Edit |
                                                        </a>
                                                        <a href="../../../proses/proses-hapus.php?id=<?php echo htmlspecialchars($article_id); ?>"
                                                            class="text-secondary font-weight-bold text-xs"
                                                            data-bs-toggle="tooltip" data-bs-title="Edit user"
                                                            onclick="confirm('yakin dek');">
                                                            hapus
                                                        </a>
                                            ...
                                            echo "<tr><td colspan='6' class='text-center'>article not found </td></tr>";
                                        } ?>



                                        <!-- Button trigger modal -->
                                        <button type="button" class="btn bg-gradient-primary ms-3"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form action="../../../proses/process_article.php" method="post"
                                                            ...
                                                            <label for="categories">Pilih Kategori:</label><br>
                                                            <?php
                                                            // Ambil daftar kategori dari database dan tampilkan sebagai checkbox
                                                            $query = "SELECT category_id, name FROM categories";
                                                            $stmt = $db->prepare($query);
                                                            $stmt->execute();

                                                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                                echo '<input type="checkbox" name="categories[]" value="' . $row['category_id'] . '"> ' . $row['name'] . '<br>';
                                                            }
                                                            ?><br>
                                                    </div>
    ...
    <!-- Sertakan JS Bootstrap dan Popper.js -->
