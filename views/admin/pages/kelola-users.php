...
require_once "../classes/post_user.php";
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Kelola Users table</h6>
                            </div>
                        </div>
                                        ...
                                        <?php if ($num > 0): ?>
                                            <tr>
                                                <?php foreach ($users as $user): ?>
                                                    ...
                                                    <?php
                                                        $encoded_id = base64_encode($user['user_id']);
                                                        ?>
                                                    <td class="align-middle">
                                                        <a href="edit-user.php?user_id=<?php echo htmlspecialchars($encoded_id); ?>"
                                                        ...
                                                        <!-- Tombol Hapus -->
                                                        <a href="../../../proses/proses-delete-user.php?user_id=<?php echo htmlspecialchars($encoded_id); ?>"
                                                            class="text-secondary font-weight-bold text-xs"
                                            ...
                                            <?php endforeach; ?>
                                        <?php else: ?>
                                            <?php echo "<tr><td colspan='6' class='text-center'>user not found </td></tr>"; ?>
                                        <?php endif; ?>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <h1>Tambah user </h1>
                                                        <form action="../../../proses/proses-user-admin-buat.php"
                                                            method="post" enctype="multipart/form-data">
                                                            <input type="hidden" name="media_id"
                                                                value="<?php echo isset($media_id) ? htmlspecialchars($media_id) : ''; ?>">
                                                            <label for="username">username :</label><br>
                                                            <input type="username" id="username" name="username"
                                                                required><br><br>

                                                            <label for="email">email :</label><br>
                                                            <input type="email" id="img1" name="email" required><br><br>
